...
from knowbase.v2.ingestion.parsers.code_parser import (
    CODE_EXTENSIONS,
    CodeParser,
    _extract_generic_top_level,
    _extract_python_top_level,
)
from knowbase.v2.ingestion.parsers.html_parser import HtmlParser
from knowbase.v2.ingestion.parsers.log_parser import (
    _detect_format,
    _extract_level,
    _split_message,
    LogParser,
...
class TestRegisterBuiltinText:
    def test_register_builtin_includes_text_parsers(self):
        ...
        fresh = __import__(
            "knowbase.v2.ingestion.parsers", fromlist=["ParserRegistry"]
        ).ParserRegistry()
